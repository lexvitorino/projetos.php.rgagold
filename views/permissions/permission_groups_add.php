<div class="page-title-group">
	...
	<h5 class="text-muted page-title-alt">Adicionar Grupo de Permissões</h5>
</div>
						...
						<div class="col-sm-12">
							<?php foreach($permission_params_list as $p): ?>
								<div class="checkbox checkbox-primary col-md-4">
									<input type="checkbox" class="form-control" name="permissions[]" value="<?php echo $p['id']; ?>" id="<?php echo $p['id']; ?>" >	
