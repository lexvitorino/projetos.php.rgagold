...
class Users extends model {
    ...
    public function setLoggedUser() {
        if(isset($_SESSION['ccUser']) && !empty($_SESSION['ccUser'])) {
            $this->userInfo = $this->getUser(0, $_SESSION['ccUser']['id']);
            ...
            $has_cidades = $this->hasPermission('cidades');
            $has_operacoes = $this->hasPermission('operacoes');
            $has_bairros = $this->hasPermission('bairros');
            $has_tipo_imoveis = $this->hasPermission('tipo_imoveis');
            $has_opcionais = $this->hasPermission('opcionais');
            $has_imobiliarias = $this->hasPermission('imobiliarias');
            $has_videos = $this->hasPermission('videos');
            $has_propriedades = $this->hasPermission('propriedades');
            ...
            $_SESSION['has_cidades'] = !empty($has_cidades)?1:0;
            $_SESSION['has_operacoes'] = !empty($has_operacoes)?1:0;
            $_SESSION['has_bairros'] = !empty($has_bairros)?1:0;
            $_SESSION['has_tipo_imoveis'] = !empty($has_tipo_imoveis)?1:0;
            $_SESSION['has_opcionais'] = !empty($has_opcionais)?1:0;
            $_SESSION['has_imobiliarias'] = !empty($has_imobiliarias)?1:0;
            $_SESSION['has_videos'] = !empty($has_videos)?1:0;
            $_SESSION['has_propriedades'] = !empty($has_propriedades)?1:0;
