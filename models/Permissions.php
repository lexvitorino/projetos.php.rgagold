...
class Permissions extends model {
    ...
    public function getListParams($offset) {
        $data = array();
    ...
    public function getCountParams($id_subscriber) {
    ...
    public function getListGroups($offset) {
        $data = array();
    ...
    public function getCountGroups($id_subscriber) {
        $sql = "SELECT COUNT(*) as qtde 
                FROM   permission_groups";
